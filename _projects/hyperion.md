...
- [Ethan Greenhall](https://gitlab.com/esg06)
- [Dan Coyle](https://gitlab.com/itsdanjc)
- [Sergio Fernandes De Azevedo Junior](https://gitlab.com/sergio.1608.junior)
...
- Fork the repository and work in feature branches.
- Document new features and keep commits clear and descriptive.
- For major changes, please discuss plans via issues before implementation.
- More information can be found in [CONTRIBUTING.md](./CONTRIBUTING.md)

## Authors
- [The Software Engineering Team](https://www.ljmu.dev/), Liverpool John Moores University
